...
for index, row in heatmap_data.iterrows():
    ...
    sns.heatmap(data, yticklabels=[index], xticklabels=heatmap_data.columns, annot=True,
                fmt='.2f', ax=axs[counter], cmap=cm[counter], cbar=False)
    counter += 1
